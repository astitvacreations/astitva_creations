        ...
        {showDesktopGuide && (
          ...
          >
            <motion.div
              ...
              animate={{ scale: 1, opacity: 1 }}
              exit={{ scale: 0.9, opacity: 0 }}
              className="bg-[#0a0a0a] border border-[#333] p-6 max-w-md w-full text-center relative shadow-2xl rounded-2xl"
            >
              <button
              ...
              <div className="bg-[#141414] p-4 rounded-xl border border-[#222] text-left text-xs text-gray-300 space-y-3">
