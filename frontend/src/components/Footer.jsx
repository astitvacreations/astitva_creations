        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            <Link to="/" className="flex items-center group mb-6">
              <img src="/logo.png" alt={`${settings.studioName} Logo`} className="h-20 w-auto object-contain transition-transform duration-300 group-hover:scale-105" />
            </Link>
          ...
          <div>
            ...
            <div className="flex gap-4 mt-8">
              ...
              <a href="https://x.com/tiru324" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-[#111] flex items-center justify-center text-[#A1A1A1] hover:bg-[var(--color-gold)] hover:text-black transition-all" title="X (Twitter)">
              ...
              <a href="https://www.imdb.com/name/nm13921429/?ref_=ext_shr" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-[#111] flex items-center justify-center text-[#A1A1A1] hover:bg-[var(--color-gold)] hover:text-black transition-all" title="IMDb">
                <span className="font-bold text-[10px] uppercase tracking-tighter leading-none flex items-center justify-center border-2 border-current px-[2px] py-[1px] rounded-[3px]">IMDb</span>
              </a>
            </div>
          </div>
        </div>
