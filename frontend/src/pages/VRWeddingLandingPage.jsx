...
import { ArrowRight, ChevronLeft, ChevronRight, X, Quote, Eye, Headphones, RotateCcw, Play } from 'lucide-react';
        ...
        <div className={`max-w-4xl mx-auto px-4 text-${data?.alignments?.about || 'center'}`}>
          ...
          >
            <span className="text-[var(--color-gold)] tracking-[0.4em] uppercase text-xs font-semibold mb-6 block">
              {data?.aboutEyebrow || 'Future of Memories'}
            </span>
            <h2 className="font-heading text-3xl md:text-4xl text-white mb-8">
              {data?.aboutTitle || 'Immersive Spatial Capturing'}
            </h2>
      ...
      >
        ...
        >
          ...
          <p className="text-[#eee] text-lg leading-relaxed mb-10 drop-shadow-md">
            {data?.ctaSubtitle || "Let's have a conversation about your VR wedding story. We'd love to learn about your vision and how we can make your memories last forever."}
          </p>
